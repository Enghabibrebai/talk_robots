...
from ur5_simulation.srv import GetPosition, GetPositionResponse

class ObjectDetection(object):
    def __init__(self):
        self.image_sub = rospy.Subscriber("/camera/camera/color/image_raw", Image, self.camera_callback)
