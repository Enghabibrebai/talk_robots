...
def filter_incoming_cloud(req: FilterSceneRequest):
    """Filter Scene to exclude red block. 
...
if __name__ == "__main__":
    try:
        ...
        service = rospy.Service('filter_workspace', FilterScene, filter_incoming_cloud)
        publisher = rospy.Publisher('/octomap_filtered', PointCloud2, queue_size=10, latch=True)
