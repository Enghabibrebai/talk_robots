...
(cl:in-package ur5_simulation-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <GetPosition-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPosition-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur5_simulation-srv:<GetPosition-request> is deprecated: use ur5_simulation-srv:GetPosition-request instead.")))

(cl:ensure-generic-function 'get_position-val :lambda-list '(m))
(cl:defmethod get_position-val ((m <GetPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur5_simulation-srv:get_position-val is deprecated.  Use ur5_simulation-srv:get_position instead.")
  (get_position m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetPosition-request>)))
  ...
  "ur5_simulation/GetPositionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPosition-request)))
  "Returns string type for a service object of type 'GetPosition-request"
  "ur5_simulation/GetPositionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetPosition-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPosition-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur5_simulation-srv:<GetPosition-response> is deprecated: use ur5_simulation-srv:GetPosition-response instead.")))

(cl:ensure-generic-function 'x_position-val :lambda-list '(m))
(cl:defmethod x_position-val ((m <GetPosition-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur5_simulation-srv:x_position-val is deprecated.  Use ur5_simulation-srv:x_position instead.")
  (x_position m))

(cl:ensure-generic-function 'y_position-val :lambda-list '(m))
(cl:defmethod y_position-val ((m <GetPosition-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur5_simulation-srv:y_position-val is deprecated.  Use ur5_simulation-srv:y_position instead.")
  (y_position m))

(cl:ensure-generic-function 'z_position-val :lambda-list '(m))
(cl:defmethod z_position-val ((m <GetPosition-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur5_simulation-srv:z_position-val is deprecated.  Use ur5_simulation-srv:z_position instead.")
  (z_position m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetPosition-response>)))
  ...
  "ur5_simulation/GetPositionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetPosition-response)))
  "Returns string type for a service object of type 'GetPosition-response"
  "ur5_simulation/GetPositionResponse")
