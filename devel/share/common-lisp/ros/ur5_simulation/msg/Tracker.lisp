...
(cl:in-package ur5_simulation-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Tracker>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tracker)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur5_simulation-msg:<Tracker> is deprecated: use ur5_simulation-msg:Tracker instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur5_simulation-msg:x-val is deprecated.  Use ur5_simulation-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur5_simulation-msg:y-val is deprecated.  Use ur5_simulation-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur5_simulation-msg:z-val is deprecated.  Use ur5_simulation-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'error_x-val :lambda-list '(m))
(cl:defmethod error_x-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur5_simulation-msg:error_x-val is deprecated.  Use ur5_simulation-msg:error_x instead.")
  (error_x m))

(cl:ensure-generic-function 'error_y-val :lambda-list '(m))
(cl:defmethod error_y-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur5_simulation-msg:error_y-val is deprecated.  Use ur5_simulation-msg:error_y instead.")
  (error_y m))

(cl:ensure-generic-function 'error_z-val :lambda-list '(m))
(cl:defmethod error_z-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur5_simulation-msg:error_z-val is deprecated.  Use ur5_simulation-msg:error_z instead.")
  (error_z m))

(cl:ensure-generic-function 'flag1-val :lambda-list '(m))
(cl:defmethod flag1-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur5_simulation-msg:flag1-val is deprecated.  Use ur5_simulation-msg:flag1 instead.")
  (flag1 m))

(cl:ensure-generic-function 'flag2-val :lambda-list '(m))
(cl:defmethod flag2-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur5_simulation-msg:flag2-val is deprecated.  Use ur5_simulation-msg:flag2 instead.")
  (flag2 m))

(cl:ensure-generic-function 'flag3-val :lambda-list '(m))
(cl:defmethod flag3-val ((m <Tracker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ur5_simulation-msg:flag3-val is deprecated.  Use ur5_simulation-msg:flag3 instead.")
  (flag3 m))
